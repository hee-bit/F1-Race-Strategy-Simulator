...
def main():
    ...
    with main_left:
        ...
        * **몬테카를로 시뮬레이션 알고리즘**: FastF1 실데이터 모델링을 기반으로 수백 가지 레이스 시나리오를 예측 연산합니다.
        ...
        st.markdown("<div style='margin-top: 15px; margin-bottom: 15px; border-top: 1px solid rgba(255,255,255,0.08);'></div>", unsafe_allow_html=True)
        ...
        * **실시간 연산 준비**: 입력 데이터를 확인하신 후 좌측 사이드바 하단의 주황색 트리거 버튼을 눌러 시뮬레이션을 개시하세요.
        ...
        st.markdown("<div style='margin-top: 15px; margin-bottom: 20px; border-top: 1px solid rgba(255,255,255,0.08);'></div>", unsafe_allow_html=True)
